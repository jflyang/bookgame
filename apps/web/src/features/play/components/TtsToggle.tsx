...
/**
 * Global TTS on/off toggle button for the play toolbar.
...
export function TtsToggle() {
  ...
  // Don't render if TTS service is not configured at all
  if (serviceConfig && serviceConfig.provider === "disabled") return null;
